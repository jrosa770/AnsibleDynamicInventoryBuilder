...
tar -czvf AnsibleDynInvBuild-$Version.tar.gz $Version

echo -e "${Green}AnsibleDynInvBuild-"$Version".tar.gz Completed"
echo -e "${NOCOLOR}"

echo -e "${Green}AnsibleDynInvBuild-"$Version".tar.gz Contents"
echo -e "${NOCOLOR}"

tar -ztvf AnsibleDynInvBuild-$Version.tar.gz
